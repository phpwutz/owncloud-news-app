...
- (NSArray*) getFolders{
    ...
    for (NSDictionary *groupDic in results) {
        Folder *folder = [[Folder alloc] initFromDictionary:groupDic];
             ...
             withUnreadOnly: (BOOL) unreadOnly
{
    ...
    for (NSDictionary *groupDic in results) {
        NewsItem *item = [[NewsItem alloc] initFromDictionary:groupDic];
                         ...
                         withType: (NEWS_API_QUERY_TYPE) type
{
    ...
    for (NSDictionary *groupDic in results) {
        NewsItem *folder = [[NewsItem alloc] initFromDictionary:groupDic];
...
- (NSArray*) getAllFeeds
{
    ...
    for (NSDictionary *groupDic in results) {
        NewsFeed *feed = [[NewsFeed alloc] initFromDictionary:groupDic];
